...
(function () {
  ...
  function socialHover() {
    ...
    var wx2 = document.getElementById('icon_wx2');
    var qrcode2 = document.getElementById('wechat2');

    function setupHover(iconId, popupId) {
    ...
    setupHover('icon_wx', 'wechat');
    setupHover('icon_wx2', 'wechat2');
  }
