...
var pageTranslations = {
    // 首页
    index: {
        'page-title': { cn: 'SL-Studio | 申聆空间设计 | 私人豪宅设计', en: 'SL-Studio | Interior Design Studio' },
        'meta-desc': { cn: '申聆空间设计，专注高端私人豪宅设计、私人公寓设计、办公室设计、商业空间设计', en: 'SL-Studio, specializing in high-end residential, apartment, office and commercial space design' },
        ...
        'intro-text': { cn: 'SL-Studio 申聆空间设计，专注于高端私人豪宅设计、私人公寓设计、办公室设计、商业空间设计。致力于为每一位客户打造独具品味的空间体验。', en: 'SL-Studio specializes in high-end residential, apartment, office and commercial space design. Committed to creating unique spatial experiences for every client.' },
        'view-more': { cn: '查看更多项目', en: 'View More Projects' },
        'footer-copy': { cn: '&copy; 2026 SL-Studio 申聆空间设计. All Rights Reserved.', en: '&copy; 2026 SL-Studio. All Rights Reserved.' },
    ...
    // 关于页面
    about: {
        'page-title': { cn: '关于我们 - SL-Studio 申聆空间设计', en: 'About Us - SL-Studio' },
        'nav-home': { cn: '首&nbsp;页', en: 'Home' },
        'nav-about': { cn: '关于我们', en: 'About Us' },
        'nav-projects': { cn: '项目精选', en: 'Projects' },
        'nav-career': { cn: '事业机会', en: 'Careers' },
        ...
        'select-career': { cn: '事业机会', en: 'Careers' },
        'select-contact': { cn: '联系我们', en: 'Contact' },
        'company-title': { cn: '申聆空间设计 SL-Studio', en: 'SL-Studio Design' },
    ...
    // 项目精选
    projects: {
        'page-title': { cn: '项目精选 - SL-Studio 申聆空间设计', en: 'Projects - SL-Studio' },
        'page-desc': { cn: 'SL-Studio 申聆空间设计，专注高端室内设计，为空间赋予独特价值。', en: 'SL-Studio specializes in high-end interior design, giving spaces unique value.' },
        'nav-home': { cn: '首&nbsp;页', en: 'Home' },
        'nav-about': { cn: '关于我们', en: 'About Us' },
        'nav-projects': { cn: '项目精选', en: 'Projects' },
        'nav-career': { cn: '事业机会', en: 'Careers' },
    ...
    // 事业机会
    career: {
        'page-title': { cn: '事业机会 - SL-Studio 申聆空间设计', en: 'Careers - SL-Studio' },
        'nav-home': { cn: '首&nbsp;页', en: 'Home' },
        'nav-about': { cn: '关于我们', en: 'About Us' },
        'nav-projects': { cn: '项目精选', en: 'Projects' },
        'nav-career': { cn: '事业机会', en: 'Careers' },
    ...
    // 联系我们
    contact: {
        'page-title': { cn: '联系我们 - SL-Studio 申聆空间设计', en: 'Contact Us - SL-Studio' },
        'nav-home': { cn: '首&nbsp;页', en: 'Home' },
        'nav-about': { cn: '关于我们', en: 'About Us' },
        'nav-projects': { cn: '项目精选', en: 'Projects' },
        'nav-career': { cn: '事业机会', en: 'Careers' },
        ...
        'company-name': { cn: '申聆空间设计 SL-Studio', en: 'SL-Studio' },
        ...
        'phone-text': { cn: '19963932624', en: '19963932624' },
    ...
    // 项目详情
    'project-detail': {
        'page-title': { cn: '项目详情 - SL-Studio 申聆空间设计', en: 'Project Details - SL-Studio' },
        'nav-home': { cn: '首&nbsp;页', en: 'Home' },
        'nav-about': { cn: '关于我们', en: 'About Us' },
        'nav-projects': { cn: '项目精选', en: 'Projects' },
        'nav-career': { cn: '事业机会', en: 'Careers' },
    ...
    // 404页面
    '404': {
        'page-title': { cn: '页面不存在 - SL-Studio 申聆空间设计', en: 'Page Not Found - SL-Studio' },
