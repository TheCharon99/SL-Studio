...
<div id="logo">
  <a href="index.html">
    <img src="images/logo.png" style="border:none;height:50px;" alt="SL-Studio Logo">
  </a>
  <div class="sns_icon">
...
<div id="footer">
  ...
  <div style="color:#999; margin:10px 0; font-size:11px;">
    <div style="float:left;"><span data-i18n="footer-copy">&copy; 2026 SL-Studio 申聆空间设计. All Rights Reserved.</span></div>
  </div>
</div>
`;
